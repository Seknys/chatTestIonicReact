...
Este proyecto es un chat funcional que permite subir imagenes y chat en tiempo real, se utilizo la libreria de cometchat para el chat y firebase para el almacenamiento de imagenes.
